...
from .salary_views import (
    ...
    salaries_account_deductions_confirm,
    salaries_aguinaldo,
    salaries_dashboard,
    salaries_monthly,
)
...
urlpatterns = [
    ...
    path('salaries/account-deductions/confirm/', salaries_account_deductions_confirm, name='salaries_account_deductions_confirm'),
